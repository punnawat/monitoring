...
<div align="center" style="padding-bottom: 10px;">
    <table style="border: 1px #734201 dashed;padding: 4px;">
        <tr>
            ...
            <td align="left" >
                <input type="text" name="txtStartDate" id="txtStartDate" /> to <input type="text" name="txtEndDate" id="txtEndDate" />
            </td>
...
<div align="center" style="padding-top: 5px;">
    <table class="sample" style="width: 950px;font-size: 12px;">        
        ...
        <tr valign="top">
            ...
            <td align="center"><a href="<?php echo site_url('bandwidth/view_graph/'.$log[$i]['device_id'].'/'.$log[$i]['id']); ?>"><img src="<?php echo base_url();?>images/view-icon.png" /></a></td>            
            <?php if($i == 0) :?>
            <td align="center" width="750" rowspan="<?php echo count($log);?>" >
               <?php if(isset($interface_bw)): ?>
                        ...
                        function drawChart() {
                            ...
                            ['Date/Time', 'In', 'Out'],
                           <?php $prevIn = 0; $prevOut = 0; ?> 
                           <?php foreach ($interface_bw->result_array() as $r): ?>
                            ['<?php echo $r['updated_date']?>',<?php echo ($r['bandwidth_in'] - $prevIn)/1024/300.0?>,<?php echo ($r['bandwidth_out']-$prevOut)/1024/300000.0?>],
                            ...
                            vAxis:  {title: 'kbps', titleTextStyle: {color: '#0B3B0B'}, minValue: 0.0, viewWindowMode: 'maximized'},
